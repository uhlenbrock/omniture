class Omniture
  ...
  def print_page_code
    out = <<-OUT
      ...
      <script language="JavaScript" type="text/javascript" src="/javascripts/s_code.js"></script>
      ...
      src="http://#{config(:account)["trackingServer"]}/b/ss/#{config(:account)["s_account"]}/1/H.20.3--NS/0"
